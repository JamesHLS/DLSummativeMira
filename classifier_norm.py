...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=(0.5070937, 0.48655552, 0.44092253), std=(0.26733243, 0.256427, 0.27613324), inplace=True),
])
...
test_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CIFAR100('data', 
                                  ...
                                  transform=transforms.Compose([transforms.ToTensor(),
                                                                transforms.Normalize(mean=(0.5070937, 0.48655552, 0.44092253), 
                                                                                        std=(0.26733243, 0.256427, 0.27613324), 
                                                                                            inplace=True)])),
